...
namespace ShieldPack.Items.Shields
{
	...
	public class BeetleShield : ModItem
	{
		public override void SetDefaults()
		{
			...
			Item.rare = 0;
			Item.accessory = true;
			Item.defense = ShieldPackConfig.Instance.shieldDefenseBeetleShield;
		}
		...
		public override void UpdateEquip(Player Player)
		{
			...
			{
				Player.velocity.X *= ShieldPackConfig.Instance.shieldWeightBeetleShield;
			}
		}
		...
		{
			if (ShieldPackConfig.Instance.recipeBeetleShield)
			{
				CreateRecipe(1)
